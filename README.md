...
- `internal/crmapi`: HTTP-клиент для взаимодействия с Jr API.
- `internal/bot`: основная логика диалогов, стейт-машина бронирования.
- `internal/db`: хранение кабинетов, их расписания и почасовых записей (SQLite).
- `internal/model`: описание доменных структур данных.
