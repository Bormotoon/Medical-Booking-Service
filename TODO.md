...
### [x] P2-2. Удалить или унифицировать дублирующую booking/schedule-логику в `bronivik_crm`
...
### [x] P2-3. Почистить и выровнять CI/CD workflow
...
### [x] P3-1. Уменьшить избыточное создание goroutine в `trackActivity()`
...
### [x] P3-2. Перестать глотать ошибки в event bus и Google Sheets sync
...
### [x] P3-3. Убрать жёсткую зависимость от `.env` и поддержать env-only deployment
...
### [x] P3-4. Добавить конкурентные ограничения уровня БД для PostgreSQL
